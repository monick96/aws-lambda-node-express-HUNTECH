...
-nuestras cuentas tienen arn para verlo es ```aws sts get-caller-identity``` en cli de aws ese arn de mi usuario lo mandams en la politica de la tabla carrera.. la [politica](./polici.json)
...
- con esa librerias que toman las credenciales que guarde, accedo a la tabla que me compartieron, la llamo por arn 
